...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Lucas Correa"
  # s.authors            = { "Lucas Correa" => "contato@lucascorrea.com" }
  # s.social_media_url   = "http://twitter.com/Lucas Correa"
  ...
  s.source       = { :git => "https://github.com/lucascorrea/SCLogger.git", :tag => "1.0" }
  ...
  #s.prefix_header_contents = '#import "SCLogger.h"'
